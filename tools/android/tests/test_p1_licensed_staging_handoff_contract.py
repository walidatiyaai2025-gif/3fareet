...
class P1LicensedStagingHandoffContractTests(unittest.TestCase):
    ...
    def test_windows_handoff_requires_clean_tracked_hero_and_rival_sources_before_unity(self):
        ...
        for required in (
            ...
            "HeroSource cannot contain ../ traversal",
            "HeroSource must resolve under a /Vehicles/ role path",
            "HeroSource cannot reuse /Rivals/ production art as the Hero source",
            "Placeholder|LegacyProcedural|Preview|Refinement|RefinementCandidates|Blockout|Review|ReviewPackaging",
