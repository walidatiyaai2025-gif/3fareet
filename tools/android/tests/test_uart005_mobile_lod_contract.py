...
class Uart005MobileLodContractTests(unittest.TestCase):
    ...
    def test_runtime_pass_rejects_fake_same_mesh_and_builds_three_level_groups(self):
        ...
        for s in ('_LOD1','_LOD2','LODGroup','ReferenceEquals','fake same-mesh LOD reuse rejected','lod0Triangles > lod1Triangles','lod1Triangles > lod2Triangles','new LOD(.56f','new LOD(.27f','new LOD(.08f','AFAREET_UART005_MOBILE_LOD_ACTIVE','sameMeshReuse=false','FindObjectsByType<Transform>'):
