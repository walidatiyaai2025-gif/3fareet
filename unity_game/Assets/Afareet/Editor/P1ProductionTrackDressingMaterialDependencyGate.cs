...
{
    public sealed class P1ProductionTrackDressingMaterialDependencyGate : IPreprocessBuildWithReport
    {
        ...
        public void OnPreprocessBuild(BuildReport report)
        {
            ...
            {
                Debug.LogWarning("AFAREET_UART007_MATERIAL_EXPERIMENTAL_GATE_BYPASS productionEvidence=false");
                return;
            }
        ...
        public static void ValidateAndroidCandidateOrThrow()
        {
            ...
            if (manifest == null || !string.Equals(manifest.taskId, "UART-007", StringComparison.Ordinal))
            ...
            Debug.Log(
                $"AFAREET_UART007_MATERIAL_DEPENDENCY_GATE_OK modules={manifest.modules.Length} " +
                "provenance=obj-mtllib-usemtl-tracked-textures rootBound=true");
        }

        private static void Fail(string detail)
        {
            throw new BuildFailedException($"AFAREET_UART007_MATERIAL_DEPENDENCY_GATE_BLOCKED {detail}");
        }
    }
}
