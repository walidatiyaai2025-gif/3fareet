...
namespace Afareet.Tests.PlayMode
{
    public sealed class AiRacerNavigationRecoveryPlayModeTests
    {
        ...
        public void SetUp()
        {
            ...
            // Production creates/configures AiRacer before RaceDirector attaches progress/reset
            // components, then freeze/release disables and reenables the AI before racing.
            ai.enabled = false;
            ai.enabled = true;
        }
