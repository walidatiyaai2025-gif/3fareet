...
namespace Afareet.Vehicle
{
    ...
    public static class RivalProductionPolicy
    {
        ...
        // The current deterministic automated stager parses an OBJ-side authored LOD/material
        // signature before resolving Unity-imported Mesh sub-assets. Final editable source can remain
        // .blend/.fbx externally, but these are the explicit tracked exchange files consumed by that path.
