...
{
    /// <summary>
    /// Visual-production floor for UART-003. The legacy generated Hero is allowed to
    /// remain as a development fallback, but it must never be accepted as production art.
    /// </summary>
