...
| U3D-010 | GPT-5.6 Sol (QA Automation / Unity Agent) | `agent/U3D-010-playmode-tests` / PR #53 | shared carve-out: additive-only `unity_game/Assets/Afareet/Tests/PlayMode/**`; U3D-010 status/evidence rows only; excludes existing EditMode/runtime/ProjectSettings/Packages files | 2026-08-13 | IN REVIEW |
