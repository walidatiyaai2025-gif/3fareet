...
| URAC-008 | GPT-5.6 Sol (Race/QA Agent) | `agent/URAC-008-ai-speed-planner` / PR #60 | Shared carve-out: new corner-speed/braking policy, racing-line lookahead policy and EditMode tests; depends on PR #58 | 2026-08-13 | IN REVIEW |
| URAC-010 | GPT-5.6 Sol (Race/QA Agent) | `agent/URAC-010-ai-recovery` | Shared carve-out: rival low-speed motion guard, checkpoint reset controller and rival finish tests; depends on PR #60 | 2026-08-13 | IN REVIEW |
