...
| UPER-001 | GPT-5.6 Sol (Performance/QA Agent) | `agent/UPER-001-device-budgets` | `docs/performance/UNITY_DEVICE_TIERS.md`; UPER-001 status/evidence rows only | 2026-08-13 | IN REVIEW |
