...
| U3D-011 | P0 | Unity CI compile + Windows artifact | GPT-5.6 Sol (Unity CI Agent) | IN REVIEW | Workflow/PR #50 implemented; Actions run blocked before Unity execution until repository Unity licensing secrets are configured |
