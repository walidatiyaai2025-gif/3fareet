...
تم تقسيم الـ293 مهمة إلى ملفات مستقلة حتى لا يضطر مطورون متعددون لتعديل نفس ملف المهام في نفس الوقت:
...
أولوية قصوى: P0/P1 Prototype tasks فقط حتى نجاح الـPlayable Prototype Gate. Backend/Online/Season work يبقى مخططًا ولكنه لا يزاحم إثبات القيادة والـDrift/Nitro والـAI والـAPK.
